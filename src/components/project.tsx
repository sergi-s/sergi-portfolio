...
type ProjectProps = (typeof projectsData)[number] | { title: string, description: string, imageUrl: string, tags: string[] }
...
export default function Project({ title, description, imageUrl, tags }: ProjectProps) {
    ...
    return <motion.div
        ...
        <section
            ...
            relative sm:h-[20rem] sm:group-even:pl-8 hover:bg-gray-200 transition 
            ...
            <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]'>
                ...
                shadow-2xl transition group-hover:scale-[1.04] group-hover:-translate-x-3 group-hover:translate-y-3 
